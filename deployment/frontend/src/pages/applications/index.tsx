...
export default function ApplicationsPage(
    ...
    const { data: applications, isLoading } = api.applications.getAllApplications.useQuery();
    ...
    function ProcessApplications() {
        ...
        const filteredApplications =
            query !== ''
                ? applications.filter((t) => indexApplications.search(query).includes(t.id))
                : applications;
    ...
    const maxStart = Math.max(0, filteredApplications.count - pagination.page.rows);
    ...
    return (
        <>
            ...
            <ApplicationSearch isLoading={isLoading} setQuery={setQuery} query={query} />
            <section className=" px-8 xxl:px-0  max-w-8xl mx-auto flex flex-col font-acumin text-xl font-light leading-loose text-neutral-700 gap-y-6 mt-16">
                <div className="max-w-[705px] ml-2 2xl:ml-2">
                    ...
                    <h3 className="pt-1 font-acumin text-xl font-light leading-loose text-neutral-700 ">
                        Browse datasets by WRI applications and data products to find data used in
