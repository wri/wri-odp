...
export default function DatasetList({ datasets }: { datasets: WriDataset[] }) {
    return (
        <section
            id="datasetslist"
            className="w-full px-4 xxl:px-0 max-w-[1317px] xxl:mx-auto flex flex-col gap-y-2 mt-10 overflow-hidden"
        >
            <h1 className=" font-semibold text-[24px] text-center sm:text-start">
