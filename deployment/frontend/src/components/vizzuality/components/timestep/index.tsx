...
class Timestep extends PureComponent {
                    ...
                    if (i === 0) {
                        stringArr = stringKeys
                            ...
                            .map((g, j) => {
                                ...
                                const index = stringKeys.findIndex(
                                    (ix) => ix === g
                                );
    ...
    render() {
        ...
        return (
            <div
                className={`${customClass} flex align-center min-h-[30px] pb-[10px]`}
            >
                ...
                <div
                    className={classnames('w-full cursor-pointer', {
                        'w-[calc(100% - 20px)] ml-[15px]': canPlay,
                    })}
                >
                    <Slider
                        range={range}
