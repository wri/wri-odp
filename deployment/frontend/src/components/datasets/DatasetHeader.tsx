            ...
            "
                ...
                <div className="flex max-w-[560px] flex-col gap-y-2">
                    <div className="flex items-center gap-x-2">
                        ...
                        {session?.data?.user &&
                            dataset?.organization?.visibility === 'private' && (
                                <span
                    ...
                    <div className="flex items-center gap-x-3">
                        ...
                        <div className="">
                            <CopyButton
                                content={`${env.NEXT_PUBLIC_CKAN_URL.replace(/\/+$/, '')}/datasets/${dataset?.name}`}
                            />
                        </div>
                    </div>
                    <p
                ...
                {dataset?.cautions && (
                    <div className="flex flex-col max-w-[560px] lg:flex-row rounded-sm bg-cyan-700 bg-opacity-10 p-[11px] pr-[30px] gap-y-2 lg:gap-x-2 lg:gap-y-0 leading-[1.125rem]">
