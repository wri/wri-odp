...
import { ArrowPathIcon, DocumentDuplicateIcon, FingerPrintIcon } from '@heroicons/react/24/outline';
...
export function TilecacheCard({
    ...
    const CopyButton = ({ content }: { content: string }) => {
        ...
        return (
            <DefaultTooltip
                content={copied ? 'Tile Cache URL copied!' : 'Copy Tile Cache URL'}
                            ...
                            {datafile?.cache_type && (
                                <span
                                    className={classNames(
                                        ...
                                        getFormatColor(datafile?.cache_type ?? '')
                                    )}
                                >
                        ...
                        <Disclosure.Panel className="py-3">
                            ...
                            <div className="mt-4">
                                <QueryEndpoint
                                    ...
                                    url={datafile.url ?? ''}
                                    method={''}
                                    copyButton={<CopyButton content={datafile.url ?? ''} />}
                                />
                            </div>
                        </Disclosure.Panel>
                    </Transition>
