...
export default function UploadButton(props: UploadProps) {
    return (
        <>
            <button className="w-full flex aspect-square flex-col items-center justify-center md:gap-y-2 rounded-[0.188rem] border-2 border-b-amber-400 bg-white shadow transition hover:bg-amber-400">
