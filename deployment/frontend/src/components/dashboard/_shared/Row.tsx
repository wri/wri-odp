...
export default function Row({
    ...
    return (
        ...
        >
            ...
            >
                <div className=" grow shrink">{rowMain}</div>
                {enableControlDiv && (
                    <div className="flex gap-x-4 ml-auto self-center mt-4 mb-2 sm:mt-0 sm:mb-0">
                        {linkButton ? (
                            <a
                                href={linkButton.link}
                                className={`flex  sm:invisible items-center gap-x-2 px-3 py-2 rounded-md  border border-wri-gold hover:bg-wri-gold bg-white font-semibold text-[15px] group-hover:visible ${groupStyle ? groupStyle : 'group-hover:visible '} `}
                            >
