...
function subFields(dataset: WriDataset) {
    return [
        ...
        },
        {
            ...
            description: datasetFormatLabel(dataset?.dataset_format_info),
        },
        {
            title: 'Release Notes',
        ...
        <div className="flex  py-3 rounded-md pl-4 sm:pl-14 gap-x-2">
            <div className="flex flex-col w-full">
                <p className="flex font-semibold text-[15px]">
                    ...
                    {dataset.visibility_type && dataset.visibility_type != 'public' && (
                        <Chip text={visibilityTypeLabels[dataset.visibility_type] ?? ''} />
                    )}
            ...
            controlButtons={[
                {
                    ...
                    color: 'bg-red-600 hover:bg-red-500',
                    icon: <StarIcon className="cursor-pointer h-4 w-4 text-white" />,
                    tooltip: {
                        id: `delete-tooltip-${dataset.name}`,
