import { ChevronDownIcon, MinusCircleIcon, Squares2X2Icon } from '@heroicons/react/24/outline';
...
export function DataFileAccordion({
    ...
    return (
        <Disclosure as="div" className="mx-auto w-full max-w-[1380px] px-4 sm:px-6 xxl:px-0">
            {({ open }) => (
                <>
                    <div
