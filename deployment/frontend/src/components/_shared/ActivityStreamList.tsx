...
export const activity: IActivity[] = [
    ...
    {
        description:
            'someone edited the Dataset XYZ Lorem ipsum this will probably be longer',
        time: '1 hour ago',
        icon: 'edit',
        actionType: 'changed_package',
    },
    {
        description:
            'someone added the Dataset XYZ Lorem ipsum this will probably be longer',
        time: '1 hour ago',
        icon: 'add',
    ...
    {
        description:
            'someone deleted the Dataset XYZ Lorem ipsum this will probably be longer',
        time: '1 hour ago',
        icon: 'update',
...
export default function ActivityStreamList() {
    return (
        <section
            className="w-full px-4 xxl:px-0 max-w-[1317px] xxl:mx-auto flex flex-col gap-y-6 mt-10 overflow-hidden"
            id="activitystream"
        >
