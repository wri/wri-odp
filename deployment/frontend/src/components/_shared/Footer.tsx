...
export default function Footer() {
  return (
    <section id="footer" className='w-full  flex font-acumin flex-col mt-16 mb-6'>
      <div className='w-full flex flex-col bg-wri-green pl-6 px-4 sm:px-14  py-10'>
        <p className='text-white mb-4 font-bold text-[1.5rem] text-center sm:text-start'>Didn&apos;t find what you were looking for? </p>
      ...
      <div className='flex flex-col'>
        ...
        <div className='max-w-sm sm:max-w-[96%] w-[96%]  mx-auto pt-16 sm:pl-16  flex flex-col sm:flex-row pr-2 gap-y-8 sm:gap-y-4 items sm:items-start'>
