...
//}
//
//function deburrUpper(str: string) {
//  // Step 1: Remove diacritical marks (accents)
//  const cleanedStr = str.normalize('NFD').replace(/[\u0300-\u036f]/g, '');
//
//  // Step 2: Convert the cleaned string to uppercase
//  const uppercasedStr = cleanedStr.toUpperCase();
//
//  return uppercasedStr;
//}
//
//export const reduceParams = (params: DecodeParam[]) => {
...
//    };
//    if (isDate) {
//      const utcDate = new Date(paramValue)
//      let date = new Date(utcDate.getUTCFullYear(),
//                               utcDate.getUTCMonth(),
//                               utcDate.getUTCDate(),
//                               utcDate.getUTCHours(),
